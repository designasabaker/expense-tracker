  ...
  const handleSubmit = async () => {
    ...
    try{
      if (isEdit) {
        ...
        await updateReceipt(authUser.uid, formFields.id, formFields.date, formFields.locationName, formFields.address, formFields.items, formFields.amount, formFields.fileName);
      }else{
